...
public class Course1_OOP_java extends AppCompatActivity {

    private static final String TAG = "Course1_OOP_Java";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course1__oop_java);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                videoView.setMediaController(new MediaController(Course1_OOP_java.this));
